            ...
            <div class="right-icons flex">
                ...
                <div class="icon-box">
                    <button class="accessibility" id="accessibility">
                        <img class="accessibility-icon inline-block dark:hidden" src="{{Vite::asset("resources/images/icons/accessibility-light.svg")}}" alt="accessibility">
                        <img class="accessibility-icon hidden dark:block" src="{{Vite::asset("resources/images/icons/accessibility-dark.svg")}}" alt="accessibility">
